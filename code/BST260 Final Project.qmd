...
pop_2020_2023 <- read.csv("../data/2020-2023 US POP by State.csv")
#2024 population by state
pop_2024 <- read.csv("../data/2024 US POP by State.csv")
...
#COVID19 cases
#online source
covid_death <- read.csv("../data/COVID19 death.csv")
...
ggplot(covid_death_state_2020_2021, 
       aes(x =death_rate_per_100k, y = reorder(state, death_rate_per_100k))) +
